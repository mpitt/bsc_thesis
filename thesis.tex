...
mitigate the digital divide, elsewhere they remind experimental
...
As Figure \emph{??} shows, the degree distributions of the three WCNs
...
As can be seen in figure \emph{??}, the three networks have a quite
...
chapter 5\emph{??}). FunkFeuer Graz has by far the highest average
...
In contrast, figure % \figref{fig:sig-wcn}
